"""
Скрипт выполняет функцию формирования request-ссылки для парсинга

- extract_brand_names() достает наименование бренда из ссылки на его страницу на маркетплейсе
- get_brands_request_urls() с помощью полученных ранее наименований создает реквест и
получает id бренда
"""
