...
- # Как пользоваться
В `WB_parser/sources/brands_urls.json` добавить ссылки на файлы интересующих компаний. (*Опционально*) В `WB_parser/sources/categories.json` добавить интересующие категории.
